...
<html>
    ...
    <head>
        ...
        <link href="C:\ProgrammingTechnologiesForTheInternet2Semestr\Лабораторная 1\style\index.css" rel="stylesheet">
        <!-- Bootstrap core CSS -->
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="index.php">Студенты</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="course.php">Направление подготовки</a>
                </li>
            </ul>
